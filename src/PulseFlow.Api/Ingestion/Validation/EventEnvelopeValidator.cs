...
public sealed class EventEnvelopeValidator
{
    ...
    public EventEnvelopeValidationResult Validate(JsonElement record)
    {
        ...
        var type = ValidateRequiredNonEmptyString(
            ...
            errors);
        var source = ValidateRequiredNonEmptyString(
            record,
            "source",
    ...
    private static DateTime? ValidateOccurredAt(
        JsonElement record,
        ICollection<EventEnvelopeValidationError> errors)
    {
        ...
        if (!record.TryGetProperty("occurredAt", out var property))
        {
            errors.Add(CreateError(
                EventEnvelopeValidationErrorCode.OccurredAtMissing,
                JsonPath));
            return null;
        }
        ...
        {
            errors.Add(CreateError(
                EventEnvelopeValidationErrorCode.OccurredAtNotString,
                JsonPath));
            return null;
        }
        ...
        {
            errors.Add(CreateError(
                EventEnvelopeValidationErrorCode.OccurredAtInvalidRfc3339,
                JsonPath));
            return null;
        }
        ...
        ICollection<EventEnvelopeValidationError> errors)
    {
        ...
        {
            errors.Add(CreateError(
                EventEnvelopeValidationErrorCode.PayloadMissing,
                JsonPath));
            return null;
        }
        ...
        {
            errors.Add(CreateError(
                EventEnvelopeValidationErrorCode.PayloadNull,
                JsonPath));
            return null;
        }
        ...
        {
            errors.Add(CreateError(
                EventEnvelopeValidationErrorCode.PayloadNotObject,
                JsonPath));
            return null;
        }
    ...
    private static EventEnvelopeValidationError CreateError(
